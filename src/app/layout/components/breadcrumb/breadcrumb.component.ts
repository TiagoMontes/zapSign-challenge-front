...
@Component({
  ...
  template: `
    <nav
      class="flex items-center justify-between py-3 px-6 bg-white border-b border-gray-200"
...
export class BreadcrumbComponent implements OnInit, OnDestroy {
  ...
  ngOnInit(): void {
    this.navigationService.breadcrumbs$.pipe(takeUntil(this.destroy$)).subscribe((breadcrumbs) => {
