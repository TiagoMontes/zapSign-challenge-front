          ...
          <li *ngFor="let item of menuItems">
            ...
            <div *ngIf="item.children" class="space-y-1">
              <button
                ...
                <span [class.hidden]="isCollapsed" class="font-medium flex-1 text-left">{{ item.label }}</span>
                <svg
                  *ngIf="!isCollapsed"
              ...
              <ul *ngIf="item.expanded && !isCollapsed" class="ml-8 space-y-1">
                <li *ngFor="let child of item.children">
                  <button
                    ...
                    <div class="w-2 h-2 rounded-full bg-gray-400" [class.bg-blue-600]="child.active"></div>
        ...
        <button
          ...
          <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path
              ...
              stroke-width="2"
              [attr.d]="isCollapsed ? 'M13 5l7 7-7 7M5 5l7 7-7 7' : 'M11 19l-7-7 7-7M19 19l-7-7 7-7'"/>
          </svg>
        </button>
      </div>
    </nav>
