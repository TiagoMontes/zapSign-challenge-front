          ...
          <mat-card class="summary-card">
            <mat-card-header>
              ...
              <mat-card-subtitle>
                ...
                Analyzed: {{ analysis.analysisDate | date:'medium' }}
              </mat-card-subtitle>
            </mat-card-header>
            <mat-card-content>
          ...
          <mat-card class="detailed-analysis-card">
            ...
            <mat-card-content>
              <mat-tab-group class="analysis-tabs">
                <mat-tab
                  *ngFor="let section of analysis.sections"
                  [label]="section.title">
                  <div class="tab-content">
                    <div class="section-header">
                      <span
                        class="importance-badge"
                        [class]="'importance-' + section.importance">
  ...
  private loadAnalysis(): void {
    ...
    setTimeout(() => {
      this.analysis = {
        ...
        summary: 'This document appears to be a standard service agreement with typical terms and conditions. The contract includes provisions for service delivery, payment terms, liability limitations, and termination clauses. Overall risk level is considered low to moderate.',
        keyTerms: ['Service Agreement', 'Payment Terms', 'Liability', 'Termination', 'Confidentiality', 'Intellectual Property'],
        riskFactors: [
        ...
        sections: [
          {
            title: 'Service Terms',
            content: 'The service terms section outlines the scope of work, deliverables, and performance expectations. The language is generally clear and reasonable.',
            importance: 'high',
            issues: ['Service scope could be more specific', 'Missing performance metrics']
          },
          {
            title: 'Payment & Billing',
            content: 'Payment terms are standard with net-30 payment periods. Invoice procedures are clearly defined.',
            importance: 'medium'
          },
          {
            title: 'Legal & Compliance',
            content: 'Standard legal provisions including governing law, jurisdiction, and compliance requirements.',
            importance: 'high',
            issues: ['Consider adding data protection clauses', 'Review indemnification terms']
          },
          {
            title: 'Termination',
            content: 'Termination clauses allow for termination with 30-day notice. Includes provisions for early termination.',
            importance: 'medium'
          }
        ]
      };
