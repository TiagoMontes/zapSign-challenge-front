...
export class PageHeaderComponent {
  ...
  getActionClasses(action: PageHeaderAction): string {
    const baseClasses = 'inline-flex items-center px-4 py-2 border font-medium rounded-lg focus:outline-none focus:ring-2 focus:ring-offset-2 transition-colors disabled:opacity-50 disabled:cursor-not-allowed';
